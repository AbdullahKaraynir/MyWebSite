...
export const content = {
  tr: {
    ...
    projectCard: {
      ...
      featured: "Öne Çıkan",
      autoSynced: "Otomatik Senkronize",
    },
    projectDetail: {
      ...
      repositoryStats: "Depo İstatistikleri",
      openIssues: "Açık Konular",
      license: "Lisans",
      defaultBranch: "Varsayılan Dal",
      createdAt: "Oluşturulma",
      lastUpdated: "Son Güncelleme",
      readmeSection: "README İçeriği",
    },
    projects: {
      recycleye: {
        title: "RecycleEye",
  ...
  en: {
    ...
    projectDetail: {
      ...
      createdAt: "Created",
      lastUpdated: "Last Updated",
      readmeSection: "README Documentation",
    },
    projects: {
      recycleye: {
        title: "RecycleEye",
